<!-- fixture: k8s-audit-log-troubleshooting (rewritten counterpart) | source: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/tasks/debug/debug-cluster/audit.md | licence: CC-BY-4.0 | derivative-licence: CC-BY-4.0 | note: prose simplified by this project; literals unchanged -->
...
a certain policy and written to a backend. The policy determines what is recorded
