<!-- fixture: osha-ppe-requirements (rewritten counterpart) | source: https://www.osha.gov/laws-regs/regulations/standardnumber/1910/1910.132 | licence: Public Domain (U.S. Government Work) | derivative-licence: MIT (this repository) | note: prose simplified by this project; literals unchanged -->
...
The employer shall assess the workplace to determine if hazards are present, or are likely to be present. Such hazards need the use of personal protective equipment (PPE). If such hazards are present, or likely to be present, the employer shall:
