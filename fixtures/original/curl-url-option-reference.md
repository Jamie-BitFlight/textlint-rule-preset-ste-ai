<!-- fixture: curl-url-option-reference | source: https://raw.githubusercontent.com/curl/curl/master/docs/cmdline-opts/url.md | licence: curl licence | retrieved: 2026-07-26 | excerpt: verbatim -->
